...
public class MarathonController {
    ...
    public String createSprint(@ModelAttribute(name = "newSprint") Sprint sprint,
                               @PathVariable(name = "marathon_id") long marathonId) {
        Sprint sprint1 = Sprint.builder()
                .title(sprint.getTitle())
                .build();
        sprintService.addSprintToMarathon(sprint1, marathonService.getMarathonById(marathonId));
